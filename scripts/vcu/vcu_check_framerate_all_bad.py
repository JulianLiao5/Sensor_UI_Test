...
def loadvcu(filename):
    ...
    radar_IDs = [0, 1, 2, 3, 4, 5]
    sonar_IDs = [0, 1]
    IDs = [0, 1, 2, 3, 4, 5, 161, 151, 141, 131, 121, 111, 171]
...
if __name__ == "__main__":
    if len(sys.argv) == 2:
        ...
        ax_2.text(100, 25, "151 interval:    mean: " + "{0:.2f}".format(np.mean(timestamp_151)) + "ms    max: " + "{0:.2f}".format(np.max(timestamp_151)) + "ms", fontdict=font)
        ...
        ax_3.text(100, 25, "141 interval:    mean: " + "{0:.2f}".format(np.mean(timestamp_141)) + "ms    max: " + "{0:.2f}".format(np.max(timestamp_141)) + "ms", fontdict=font)
        ax_3.grid(True)
        curves = ["VCU  -  141"]
        ...
        ax_4.text(100, 25, "131 interval:    mean: " + "{0:.2f}".format(np.mean(timestamp_131)) + "ms    max: " + "{0:.2f}".format(np.max(timestamp_131)) + "ms", fontdict=font)
        ax_4.grid(True)
        curves = ["VCU  -  131"]
        ...
        ax_5.text(100, 25, "121 interval:    mean: " + "{0:.2f}".format(np.mean(timestamp_121)) + "ms    max: " + "{0:.2f}".format(np.max(timestamp_121)) + "ms", fontdict=font)
        ax_5.grid(True)
        curves = ["VCU  -  121"]
        ...
        ax_6.text(100, 25, "111 interval:    mean: " + "{0:.2f}".format(np.mean(timestamp_111)) + "ms    max: " + "{0:.2f}".format(np.max(timestamp_111)) + "ms", fontdict=font)
        ax_6.grid(True)
        curves = ["VCU  -  111"]
        ...
        ax_7.text(100, 25, "171 interval:    mean: " + "{0:.2f}".format(np.mean(timestamp_171)) + "ms    max: " + "{0:.2f}".format(np.max(timestamp_171)) + "ms", fontdict=font)
        ax_7.grid(True)
        curves = ["VCU  -  171"]
        ...
        ax_radar_1.text(100, 30, "ID0 interval:    mean: " + "{0:.2f}".format(np.mean(ts_radar_0)) + "ms    max: " + "{0:.2f}".format(np.max(ts_radar_0)) + "ms", fontdict=font)
        #ax_1.set_ylabel('ID0 diff timestamp[milliseconds]', size=10)
        ...
        ax_radar_2.text(100, 30, "ID1 interval:    mean: " + "{0:.2f}".format(np.mean(ts_radar_1)) + "ms    max: " + "{0:.2f}".format(np.max(ts_radar_1)) + "ms", fontdict=font)
        font = {'family': 'serif',
                #'color':  'green',
                'color':  'black',
                'weight': 'normal',
        ...
        ax_radar_3.text(100, 30, "ID2 interval:    mean: " + "{0:.2f}".format(np.mean(ts_radar_2)) + "ms    max: " + "{0:.2f}".format(np.max(ts_radar_2)) + "ms", fontdict=font)
        ...
        ax_radar_4.text(100, 30, "ID3 interval:    mean: " + "{0:.2f}".format(np.mean(ts_radar_3)) + "ms    max: " + "{0:.2f}".format(np.max(ts_radar_3)) + "ms", fontdict=font)
        ...
        ax_radar_5.text(100, 30, "ID4 interval:    mean: " + "{0:.2f}".format(np.mean(ts_radar_4)) + "ms    max: " + "{0:.2f}".format(np.max(ts_radar_4)) + "ms", fontdict=font)
        ...
        ax_radar_6.text(100, 30, "ID5 interval:    mean: " + "{0:.2f}".format(np.mean(ts_radar_5)) + "ms    max: " + "{0:.2f}".format(np.max(ts_radar_5)) + "ms", fontdict=font)
        ...
        ax_sonar_1.text(100, 20, "ID0 interval:    mean: " + "{0:.2f}".format(np.mean(ts_sonar_0)) + "ms    max: " + "{0:.2f}".format(np.max(ts_sonar_0)) + "ms", fontdict=font)
        #ax_1.set_ylabel('ID0 diff timestamp[milliseconds]', size=10)
        ...
        ax_sonar_2.text(100, 20, "ID1 interval:    mean: " + "{0:.2f}".format(np.mean(ts_sonar_1)) + "ms    max: " + "{0:.2f}".format(np.max(ts_sonar_1)) + "ms", fontdict=font)
        #ax_2.set_ylabel('ID1 diff timestamp[milliseconds]', size=10)
