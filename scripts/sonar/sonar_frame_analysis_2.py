    ...
    with open(filename) as myfile:
        with open('filter_sonar.txt', 'w+') as filter_file:
            for line in myfile:
                ...
                if re.search("sonar_obj3", line, re.IGNORECASE):
                    ...
                    name, var = line.partition("linux_time: ")[::2]
                    linux_timestamp_item_0 = var.split(" ")[0]
                    linux_timestamp_val_0 = float(linux_timestamp_item_0)
