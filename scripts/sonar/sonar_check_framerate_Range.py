...
if __name__ == "__main__":
    if len(sys.argv) == 2:
        ...
        range_0, ts_0, range_1, ts_1, range_2, ts_2, range_3, ts_3, range_4, ts_4, range_5, ts_5, range_6, ts_6, range_7, ts_7  = loadradar(sys.argv[1])
        ## print(timestamp_0)
        dt_0 = np.diff(ts_0)
        dt_1 = np.diff(ts_1)
        dt_2 = np.diff(ts_2)
        ...
        if 0 == len(range_2):
            ...
            ax_range_2.text(0.5, 0.5, "min: " + "{0:.1f}".format(np.min(range_2)) + "    mean: " + "{0:.1f}".format(np.mean(range_2)) + "    max: " + "{0:.1f}".format(np.max(range_2)), horizontalalignment='center', verticalalignment='center', transform=ax_range_2.transAxes, fontdict=font)
        ...
        if 0 == len(range_4):
            ...
            ax_range_4.text(0.5, 0.5, "min: " + "{0:.1f}".format(np.min(range_4)) + "    mean: " + "{0:.1f}".format(np.mean(range_4)) + "    max: " + "{0:.1f}".format(np.max(range_4)), horizontalalignment='center', verticalalignment='center', transform=ax_range_4.transAxes, fontdict=font)
        ...
        if 0 == len(range_5):
            ...
            ax_range_5.text(0.5, 0.5, "min: " + "{0:.1f}".format(np.min(range_5)) + "    mean: " + "{0:.1f}".format(np.mean(range_5)) + "    max: " + "{0:.1f}".format(np.max(range_5)), horizontalalignment='center', verticalalignment='center', transform=ax_range_5.transAxes, fontdict=font)
        ...
        if 0 == len(range_6):
            ...
            ax_range_6.text(0.5, 0.5, "min: " + "{0:.1f}".format(np.min(range_6)) + "    mean: " + "{0:.1f}".format(np.mean(range_6)) + "    max: " + "{0:.1f}".format(np.max(range_6)), horizontalalignment='center', verticalalignment='center', transform=ax_range_6.transAxes, fontdict=font)
